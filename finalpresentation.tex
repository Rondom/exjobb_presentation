...
\begin{document}
    ...
    \section{Existing Solutions}
        \include{frames/02_1_existing_solutions}
        \include{frames/02_2_existing_solutions}
    \section{Background}
        \include{frames/03_1_fuse}
        \include{frames/03_2_libguestfs}
        \include{frames/03_3_rump_splash}
        \include{frames/03_4_rump}
        \include{frames/03_5_lkl}

    \section{Implementation}
        \include{frames/04_implementation}
    \section{Evaluation}
