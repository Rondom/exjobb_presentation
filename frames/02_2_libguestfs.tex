...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item FUSE filesystem available as well
    \end{itemize}
...
\end{center}
    ...
    \note{
        \begin{itemize}
            \item library and suite of utilities for offline FS access
            \item conversion of physical or virtual to virtual, install OS, tail-f
            \item runs a stripped down Linux appliance using KVM (Hypervisor built into Linux kernel) for FS-access
